          ...
          <div className="container py-md-4">
            <div className="row footer-top-29">
              <div className="col-lg-4 col-md-6 col-sm-7 footer-list-29 footer-1 pr-lg-5">
                ...
                <p>
                  Address :32/81 Rajaji Street.
                </p>
                <p className="my-2">
                  Phone : <a href="tel:9466715001">9466715001</a>
                </p>
                <p>
                  Email : <a href="v.sowndharya2000@gmail.com">v.sowndharya2000@gmil.com</a>
                </p>
        ...
        <section className="w3l-copyright text-center">
          <div className="container">
            <p className="copy-footer-29">
              © 2024 Study Course. All rights reserved. Design by
            Sowndharya
            </p>
          </div>
